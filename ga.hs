...
--Generate a integer permuted cromossome
generate_integer_permuted_cromossome :: Int -> (Int, Int) -> IO Cromossome
generate_integer_permuted_cromossome n_genes _ = do
    perm <- permutations [1..n_genes]
    return perm
...
generate_population IntegerPermuted n_population n_genes interval = do
    pop <- generate_integer_permuted_cromossome n_genes interval
    return $ pop
...
main = do
    ...
    integer_permuted_population <- generate_population IntegerPermuted 3 5 (0,5)
